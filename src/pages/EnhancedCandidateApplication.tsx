...
import { ArrowLeft, MapPin, DollarSign, Clock, Building, Briefcase, AlertCircle, Camera, Shield, FileText } from 'lucide-react';
                      ...
                      <div className="space-y-3 mb-6 flex-1">
                        ...
                        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
                          ...
                          <p className="text-xs text-blue-700 dark:text-blue-300">
                            15-minute monitored assessment with face detection, screen lock, and audio recording.
                          </p>
                        </div>
                      </div>
